package cn.aixan.constant;

/**
 * 消息常量
 * @author aix QQ:32729842
 * @version 2022-09-02 14:47
 */
public class MessageConstant {
    public static final String MESSAGE_WRONG_PARAMETER = "请求参数有误";
    public static final String MESSAGE_ILLEGAL_PARAMETER = "请求参数非法";
    ...
    public static final String ADD_ROLE_FAIL = "新增权限失败";
    public static final String ADD_ROLE_SUCCESS = "新增权限成功";
    public static final String DELETE_ROLE_FAIL = "删除权限失败";
    public static final String DELETE_ROLE_SUCCESS = "删除权限成功";
    public static final String QUERY_ROLE_SUCCESS = "查询权限成功";
    public static final String QUERY_ROLE_FAIL = "查询权限失败";
    public static final String EDIT_ROLE_FAIL = "编辑权限失败";
    public static final String EDIT_ROLE_SUCCESS = "编辑权限成功";
